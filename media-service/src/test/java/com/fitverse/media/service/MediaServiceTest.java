...
class MediaServiceTest {
    ...
    @Mock
    private MinioConfiguration.MinioProperties minioProperties;

    private MediaService service;

    @BeforeEach
    void setUp() {
        service = new MediaService(repository, mapper, minioClient, minioProperties);
    }

    @Test
    void uploadCreatesMediaAsset() throws Exception {
        when(minioProperties.getBucket()).thenReturn("fitverse");
